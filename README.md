...
Friends: Just message me to add your art, I'll handle it \
Strangers: Please submit a [Ticket](https://github.com/amorphea/v/issues) or a [Pull Request](https://github.com/amorphea/v/pulls) to add your artworks (whichever you prefer), and I'll handle it from there
